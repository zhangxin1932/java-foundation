...
import com.zy.foundation.lang.security.Base64Tools;
...
import static com.zy.foundation.lang.security.Base64Tools.base64ToFile;
import static com.zy.foundation.lang.security.Base64Tools.fileToBase64;
...
public class Base64ToolsTest {
    ...
    //////////////////////////////////////////////=======apache版本======///////////////////////////////////////////////////////////////
    /**
     * org.apache.com.zy.foundation.codec.binary.Base64类也可以进行编码和解码
     * 编码之后或解码之前去除换行符
     * 编码和解码使用相同的jdk版本
     */
    @Test
