...
public final class SimpleHttpClientFactory {
    ...
    public static CloseableHttpClient buildWithSSLOSecret(HttpProfile profile) {
        ...
        RequestConfig requestConfig = RequestConfig.custom()
                ...
                .setConnectionRequestTimeout(profile.getConnectionTimeoutInMills())
                .build();
        Registry<Object> register = RegistryBuilder.create().register("accept-all", EASY_COOKIE_SPEC_PROVIDER).build();
        // 构建客户端
        return HttpClientBuilder.create()
                .setConnectionManager(connectionManager)
                .setDefaultRequestConfig(requestConfig)
                //.setDefaultCookieSpecRegistry(register)
    ...
    protected static final TrustManager TRUST_ALL_MANAGER = new X509TrustManager() {
        @Override
    ...
    protected static final CookieSpecProvider EASY_COOKIE_SPEC_PROVIDER = (context1) -> new DefaultCookieSpec(DATE_PATTERNS, false);
}
